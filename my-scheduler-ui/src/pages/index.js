...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 text-center px-4">
      <h1 className="text-4xl font-bold text-violet-700 dark:text-violet-400 mb-4">Welcome to TempoSort</h1>
      <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">Your personal task scheduler</p>
